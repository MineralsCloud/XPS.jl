...
[`ExpressCommands`](https://github.com/MineralsCloud/ExpressCommands.jl).
...
version of `ExpressCommands`, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/ExpressCommands.jl"
```
...
our [GitHub repository](https://github.com/MineralsCloud/ExpressCommands.jl)
for new releases.
Once we release a new version, you can update `ExpressCommands` by typing
